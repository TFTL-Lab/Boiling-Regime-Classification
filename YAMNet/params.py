...
class Params:
  sample_rate: float = 10000.0  ## changed 1
  stft_window_seconds: float = 0.010 #0.025 #
  stft_hop_seconds: float = 0.010 ##changed 
  mel_bands: int = 64
  mel_min_hz: float = 0 ## changed 2
  mel_max_hz: float = 2000  ## changed 3
  log_offset: float = 0.001
  patch_window_seconds: float =  1.00 ##changed 0.96 ##
  patch_hop_seconds: float = 1.00 ##changed 0.48 ##
